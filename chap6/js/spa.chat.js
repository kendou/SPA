...
spa.chat = (function (){
	...
	scrollChat = function(){
	  ...
	  var scrollHeight = $msg_log.prop('scrollHeight'), viewHeight = $msg_log.height();
	  $msg_log.animate(
	      {scrollTop : scrollHeight - viewHeight},
	      150
	    );
	};
	...
	onSetchatee = function(event, arg_map){
	  ...
	  jqueryMap.$list_box
	   ...
	   writeAlert('Now chattting with ' + arg_map.new_chatee.name);
